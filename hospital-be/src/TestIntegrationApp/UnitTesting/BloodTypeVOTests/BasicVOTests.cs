...
namespace TestIntegrationApp.UnitTesting.BloodTypeVOTests
{
    public class BasicVOTests
    {
        ...
        {
            BloodType a_neg = new BloodType(BloodTypeTitle.A, RHFactor.NEGATIVE);
            BloodType a_neg2 = new BloodType(BloodTypeTitle.A, RHFactor.NEGATIVE);
        ...
        {
            BloodType a_neg = new BloodType(BloodTypeTitle.A, RHFactor.NEGATIVE);
            BloodType b_pos = new BloodType(BloodTypeTitle.B, RHFactor.POSITIVE);
