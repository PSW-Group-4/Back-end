...
{
    public class RenovationSessionNewRoomsCreatedEventConfiguration : IEntityTypeConfiguration<NewRoomsCreated>
    {
        public void Configure(EntityTypeBuilder<NewRoomsCreated> builder)
        {
